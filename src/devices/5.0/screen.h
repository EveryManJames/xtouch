...
// RGB data bus + panel timing. Pins and porches match the canonical Arduino_GFX
// ESP32_8048S043 config, which is the standard mapping for this 8048 board
// family (verified against Arduino_GFX master).
//
// If the display is blank or rolls, the porch values are the thing to adjust:
// the 7" sibling (ESP32_8048S070) uses hsync 180/30/16, vsync 12/13/10 at
// 12 MHz. Try those before touching anything else.
...
Arduino_RGB_Display *gfx = new Arduino_RGB_Display(
    800 /* width */, 480 /* height */, xtouch_rgbpanel,
